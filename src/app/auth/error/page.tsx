...
// 1. We moved your original component logic into a new "Content" component
function AuthErrorContent() {
  ...
  return (
    <>
      {/* Branding */}
      <div className="relative z-10 flex items-center gap-2.5 mb-10 mt-10">
...
// 2. This is the new default export that wraps the content in Suspense
export default function AuthError() {
  return (
    ...
    >
      ...
      {/* The Suspense boundary catches the useSearchParams hook */}
      <Suspense fallback={<div className="relative z-10 text-emerald-500 animate-pulse">Loading...</div>}>
        <AuthErrorContent />
      </Suspense>
    </div>
  );
